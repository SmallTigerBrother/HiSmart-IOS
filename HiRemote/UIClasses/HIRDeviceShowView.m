...
- (id)init{
    ...
    if (self) {
       ...
       // self.avatarImageView.backgroundColor = [UIColor redColor];
        ...
        self.deviceNameLabel.font = [UIFont boldSystemFontOfSize:18];
        ...
        self.deviceLocationLabel.font = [UIFont systemFontOfSize:14];
...
- (void)updateConstraints
{
    if (!self.didSetupConstraints) {
        [self.avatarImageView autoSetDimensionsToSize:CGSizeMake(85, 85)];
        [self.avatarImageView autoAlignAxisToSuperviewAxis:ALAxisVertical];
        [self.avatarImageView autoPinEdgeToSuperviewEdge:ALEdgeTop withInset:8];
        
        [self.batteryPercent autoSetDimensionsToSize:CGSizeMake(90, 90)];
        [self.batteryPercent autoAlignAxisToSuperviewAxis:ALAxisVertical];
        [self.batteryPercent autoPinEdgeToSuperviewEdge:ALEdgeTop withInset:5];
        
        [self.deviceNameLabel autoSetDimension:ALDimensionHeight toSize:28];
        ...
        [self.deviceNameLabel autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:self.batteryPercent withOffset:5.0];
        
        [self.deviceLocationLabel autoSetDimension:ALDimensionHeight toSize:22];
        ...
        [self.deviceLocationLabel autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:self.deviceNameLabel withOffset:-5];
